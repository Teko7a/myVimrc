...
nnoremap <silent> X :RnvimrToggle<CR><C-\><C-n>:RnvimrResize 0<CR>
let g:rnvimr_action = {
...
function NewFileCode()
  " :call NewFileHeader()
  :0r ~/.config/nvim/cppfile/code.cpp
endfunc

function NewFileCodF()
  " :call NewFileHeader()
  :0r ~/.config/nvim/cppfile/cf.cpp
endfunc
